...
public class RoCrateExporter {
    ...
    public DataEntity addPublication(PublishedData publication, boolean asRootEntity) {
        ...
        publication.getCreator().forEach(creator -> {
        ...
        publicationBuilder
                ...
                .addProperty(StaticEntities.SchemaDOAbstract.getLocalName(), publication.get_abstract())
