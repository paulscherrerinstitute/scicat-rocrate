...
public class RdfSerdeTest {
        ...
        public void test00() throws Exception {
                ...
                Assertions.assertFalse(deserializer.deserialize(model.createResource(), Instant.class).isValid());
        ...
        public void test02() throws Exception {
                ...
                DeserializationReport<TestClasses.Arrays> report = deserializer.deserialize(r,
                                TestClasses.Arrays.class);
                ...
                Assertions.assertEquals(new HashSet<>(instance.stringArray),
                                new HashSet<>(deserializedInstance.stringArray));
                Assertions.assertEquals(new HashSet<>(instance.integerArray),
                                new HashSet<>(deserializedInstance.integerArray));
                Assertions.assertEquals(new HashSet<>(instance.doubleArray),
                                new HashSet<>(deserializedInstance.doubleArray));
                Assertions.assertEquals(new HashSet<>(instance.floatArray),
                                new HashSet<>(deserializedInstance.floatArray));
                Assertions.assertEquals(new HashSet<>(instance.booleanArray),
                                new HashSet<>(deserializedInstance.booleanArray));
        }
        ...
        public void test04() throws Exception {
                ...
                DeserializationReport<PrimitiveTypes> report = deserializer.deserialize(r, PrimitiveTypes.class);
                Assertions.assertTrue(report.isValid());
                Assertions.assertNotNull(report.get());
