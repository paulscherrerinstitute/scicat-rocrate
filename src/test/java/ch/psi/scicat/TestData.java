...
public class TestData {
    ...
    static {
        examplePublishedData = new PublishedDataBuilder()
                ...
                ._abstract("Publication 1 - Abstract")
                .dataDescription("Publication 1 - Data description")
                .resourceType("derived")
                .numberOfFiles(100)
                .sizeOfArchive(100)
                .pidArray(List.of("20.500.11935/dataset-1", "20.500.11935/dataset-2", "20.500.11935/dataset-3"))
